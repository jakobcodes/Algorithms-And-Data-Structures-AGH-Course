...
if __name__ == '__main__':
    ...
    xd = 22
    print(xd)
    if poprzednik(root,xd) != None:
        print(f"poprzednik: {poprzednik(root,xd).key}")
    
    if nastepnik(root,xd) != None:
        print(f"nastepnik: {nastepnik(root,xd).key}")
